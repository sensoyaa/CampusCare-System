...
<head>
    ...
    <?php if (in_array(basename($_SERVER["PHP_SELF"]), ["events.php", "view_college_events.php"], true)): ?>
    <link rel="stylesheet" href="/campuscare-api/php-frontend/assets/events.css">
    <?php endif; ?>
    ...
    <script src="/campuscare-api/php-frontend/assets/profile-dropdown.js" defer></script>
        ...
        <script src="/campuscare-api/php-frontend/assets/notifications-handler.js" defer></script>
    <script>
    (function () {
        try {
